...
# Launch user script
sudo BOOT_PHASE=${BOOT_PHASE} REPO_SLUG=${REPO_SLUG} REPO_BRANCH=${REPO_BRANCH} REPO_COMMIT=${REPO_COMMIT} EASYNAME=${EASYNAME} -i -u ${USERNAME} /home/${USERNAME}/run_user.sh
